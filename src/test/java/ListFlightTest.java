...
public class ListFlightTest {
    ...
    public void threeFilterTest(){
        ...
        ListFlight test= new ListFlight(List.of(new Flight(List.of(new Segment(LocalDateTime.now().minusHours(1),LocalDateTime.now().minusHours(2)))),
                new Flight(List.of(new Segment(LocalDateTime.now().plusMinutes(1),LocalDateTime.now().plusHours(4)),new Segment(LocalDateTime.now().plusDays(2),LocalDateTime.now().plusDays(1).plusHours(2)))),
                new Flight(List.of(new Segment(LocalDateTime.now().plusMinutes(1),LocalDateTime.now().plusDays(1).plusHours(4)),new Segment(LocalDateTime.now().plusDays(1).plusHours(7),LocalDateTime.now().plusDays(1).plusHours(2))))));
